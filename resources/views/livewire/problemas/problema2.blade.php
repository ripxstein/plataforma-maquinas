<div class="steps">
        ...
        <div class="pstep" style="margin-top:14px;">
            ...
            <div class="grid-2">
                <div class="card">
                    ...
                    <ul>
                        <li>Área nominal: <strong>320 mm²</strong></li>
        ...
        <div class="footer-note" style="margin-top:16px;">
            ...
            <div style="display:flex; flex-wrap:wrap; gap:10px; align-items:center; margin-top:10px;">
                <select wire:model="nextStepAnswer" style="padding:8px 12px; border-radius:10px; border:1px solid var(--borde);">
                    <option value="">Selecciona una opción</option>
                    <option value="sigma_nom_a">Calcular σnom,A</option>
                    <option value="relacion_a">Calcular D/W</option>
                    <option value="kt_a">Obtener Kt,A de la gráfica</option>
                    <option value="sigma_max_a">Calcular σmax,A</option>
                    <option value="area_b">Calcular área de la opción B</option>
                    <option value="sigma_nom_b">Calcular σnom,B</option>
                    <option value="relaciones_b">Calcular r/d y D/d</option>
                    <option value="kt_b">Obtener Kt,B de la gráfica</option>
                    <option value="sigma_max_b">Calcular σmax,B</option>
                    <option value="comparacion">Comparar opciones</option>
                </select>
    ...
    @if ($currentStep >= 12)
        <img
            ...
            alt="Simulación de barras con muesca"
